...
public class VikasietumPizza
{
	...
	public static void main(String[] args) 
    {
		...
		System.out.println("Welcome to vikasietum Pizza Factory");
		int flag = 1;
		String type=null;
		while(flag==1)
		{
		System.out.println("Press 1         :     Vegetarian Pizza ");
		System.out.println("Press 2         :     Non-Vegetarian Pizza");
		System.out.println("Press 3         :     Side dishes");
	...
	private static int sides() {
		System.out.println("Press 1:  Cold drink");
		System.out.println("Press 2:  Mousse cake");
	...
	private static int nonVegetarian() {
			System.out.println("Press 1:  Non-Veg Supreme Pizza");
			System.out.println("Press 2:  Chicken tikka Pizza");
			System.out.println("Press 3:  Pepper Barbecue Pizza");
			int press = sc.nextInt();
			String type=null;
			switch(press)
			{
	...
	private static int selectTopings() {
		   System.out.println("Press 1:  Veg toppings");
		   System.out.println("Press 2:  Non-Veg toppings");
		   System.out.println("Press 3:  Both");
		   System.out.println("Press 4:  Extra Cheese");
	       int press = sc.nextInt();
	       int cost=0;
	       String type="non veg";
	       switch (press) 
		...
		{
			System.out.println("Press 1: Deluxe Veggie");
			System.out.println("Press 2: Cheese and Corn");
			System.out.println("Press 3: Paneer tikka");
		...
		{
			System.out.println("Press 1: New hand tossed");
			System.out.println("Press 2: Wheat thin crust");
			System.out.println("Press 3: Cheese burst");
			System.out.println("Press 4: Fresh pan pizza");
			int press = sc.nextInt();
			switch(press)
			{
		...
		public static int vegtoppings(String type)
		{
			...
			System.out.println("Press any number: No");
	        int press = sc.nextInt();
	        if(press == 1)
	        {
			...
			{
				sum = sum + val; 
			System.out.println("   Press 1:     Black olive");
			System.out.println("   Press 2:     Capsicum");
			System.out.println("   Press 3:     Paneer");
			System.out.println("   Press 4:     Mushroom");
			System.out.println("   Press 5:     Fresh Tomato");
			System.out.println("   Press 6:     Extra Cheese");
			System.out.println("Press any Number: Exit");
			press = sc.nextInt();
		...
		public static int nonVegToppings()
		{
			...
			System.out.println("Press 1: Chicken tikka");
			System.out.println("Press 2: Barbecue Chicken");
			System.out.println("Press 3: Grilled Chicken");
			int press = sc.nextInt();
			String toppings= null;
			int cost=0;
			switch(press)
		...
		public static int vegbase(int x)
		{
			...
			System.out.println("Press 1: Regular");
